...
<div class="row">
    ...
    <div class="col-md-8">
		...
		{
			echo $interest_amt = $rslacc_loanaccount['lacc_loanamt'] * ($rslacc_loanaccount['lacc_intrate']/100);
		}
		else
		{
...
<div class="read-icon">
	<div class="col-lg-6 col-md-6 mt-6" style="text-align: left"><input type="submit" name="submitreject" id="submitreject" class="btn btn-danger" value="Reject Loan Application"></a></div>					
