...
if(isset($_POST['submit']))
{
	...
	if(mysqli_affected_rows($con) == 1)
	{
		...
		$msg= str_replace(" ","%20","Your Foreclosure payment to $txtloanacno has been made on "  . $dts  . " for the amount of Rs. ". $paymentamt. " and Your Loan account has been closed. Thank You for Payment.. -PERKSFinance");
		$ch = curl_init();
...
<form method="post" action=""  >
 ...
 <h3 class="heading3"> ForeClosure Chart</h3>
	...
	<table  class="table table-striped table-bordered">
		...
		<tbody>
			...
			while($rs = mysqli_fetch_array($qsql))
			{
				...
				echo "<tr>
						...
						$balamts = $totamt - $rsloanpmt['loanpaid'];
				echo "<td style='text-align: right'>" . moneyFormatPhil($balamts) . "</td>";
		...
		<THEAD>
			<tr>
				...
				<th style="text-align: right;"><?php echo moneyFormatPhil($totamttopay); ?></th>
			</tr>
		</THEAD>
	</table>
