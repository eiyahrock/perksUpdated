...
<br>
 <h3 class="heading3"> View <?php echo $_GET['status']; ?> Loan Applications</h3>
...
if($rs['comp_name'] != "")						
{
	echo "<b>$rs[comp_name]</b>";
				...
				echo "</td>
						...
						<td style='font-size: 20px;'>". moneyFormatPhil(floor($rs['lacc_loanamt'])) ."</td>";
				echo "<td style='font-size: 20px;'>". moneyFormatPhil(floor($rs['interest_amt'])) ."</td>";
				$totamt = $rs['lacc_loanamt'] +$rs['interest_amt'] ;
				echo "<td style='font-size: 20px;'>". moneyFormatPhil($totamt) ."</td>";
if(isset($_SESSION['usr_id']))
{						
