...
?>
 ...
 <h3 class="heading3"> View Loan Transaction</h3>
		...
		<tbody>
			...
			while($rs = mysqli_fetch_array($qsql))
			{
				...
				if($rs['ltr_transtype'] == "Principal" || $rs['ltr_transtype'] == "Interest" || $rs['ltr_transtype'] == "Legal Case" || $rs['ltr_transtype'] == "Cheque Bounce" || $rs['ltr_transtype'] == "Others" || $rs['ltr_transtype'] == "Delay Payment")
				{
					...
					echo moneyFormatPhil($rs['ltr_amt']);
				}
				echo "</td>";				
				echo "<td style='text-align: right;'>";
				...
				echo "</td>";
				echo "<td style='text-align: right;'>" . moneyFormatPhil($itamt) . "</td>";
				echo "<td>";
				if($rs['ltr_transtype'] == "Payment" || $rs['ltr_transtype'] == 'Foreclosure')
				{
...
echo "<tr>
		...
		<td>" . $foreclosuredt . "</td>
		<td>" . $foreclosure . "</td>
		<td style='text-align: right;'>" . moneyFormatPhil($foreclosureamt) ."</td>
		<td style='text-align: right;'></td>
		<td style='text-align: right;'>" . moneyFormatPhil($itamt). "</td>
		<td></td>
	</tr>";						
			}
			?>
