...
<div class="row">
    ...
    <div class="col-md-8">
		...
		{
			echo $interest_amt = $rslacc_loanaccount['lacc_loanamt'];
		}
		else
		{
...
<tr>
	<td><?php echo $ins; ?></td>
	<td style="width: 25%;text-align: right;"><?php echo moneyFormatPhil($emilacc_loanamt); ?></td>
	<td style="width: 25%;text-align: right;"><?php echo moneyFormatPhil($emiintamt); ?></td>
	<td style="width: 25%;text-align: right;"><?php echo moneyFormatPhil($totemiamt); ?></td>
</tr>
<?php
}
?>
		...
		<TFOOT>
			<tr>
				...
				<th style="width: 25%;text-align: right;"><?php echo moneyFormatPhil($rslacc_loanaccount['lacc_loanamt']); ?></th>
				<th style="width: 25%;text-align: right;"><?php echo moneyFormatPhil($interest_amt); ?></th>
				<th style="width: 25%;text-align: right;"><?php echo moneyFormatPhil($rslacc_loanaccount['lacc_loanamt']+$interest_amt); ?></th>
			</tr>
		</TFOOT>
		</table>
    </div>
	...
	<table>	
		<tr>
			<td><input type="checkbox" name="submitcheckbox" id="submitcheckbox" class="btn btn-danger" value="Reject Loan offer" style="width: 20px;height: 20px;padding-left: 3px;"></td>
			<td> <b onclick="return false;" id="myBtn" style="color: brown;cursor: pointer;"> &nbsp;I Accept PERKSFinance Terms and Conditions..</b></td>
		</tr>
	</table>
	<hr>
	</div>
...
<div class="read-icon">
	<div class="col-lg-6 col-md-6 mt-6" style="text-align: left"><input type="submit" name="submitreject" id="submitreject" class="btn btn-danger" value="Reject Loan offer"
