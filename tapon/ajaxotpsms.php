...
<?php
$mobno=$_GET['mobno'];
$msg= str_replace(" ","%20","Thanks for Registration. Your PERKSFinance One Time Password(OTP) verification code is $randomotp. Don't share it with anyone. OTP is valid for 15 minutes...");
$ch = curl_init();
