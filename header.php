...
//$_SESSION['pancardno'] = "ID Number";
$_SESSION['pancardno'] = "ID Number";
//$_SESSION['ifsccode'] = "Zip Code";
$_SESSION['ifsccode'] = "Zip Code";
...
function moneyFormatPhil($num) {
    ...
    return $_SESSION['currencysymbol'] . $thecash; // writes the final format where $currency is the currency symbol.
}
...
?>
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu">
        ...
        <!-- <a class="dropdown-item" href="viewstates.php">VIEW STATE</a> -->
      </div>
    </li>
...
<header>
	<div class="container">
		<div class="header d-lg-flex justify-content-between align-items-center py-lg-3 px-lg-3">
			<!-- logo -->
			<div id="logo">
				<h1 class="heading3"><a href="index.php"><span class="fa fa-money mr-2"></span>PERKS</a></h1>
			</div>
			<!-- //logo -->
			<div class="w3pvt-bg" style="background-color:transparent; ">
				<!-- nav -->
				<div class="nav_w3pvt">
	<nav>
...
{
?>
<a  class="btn read" style="background-color: gold; color:black;" href="dashboard.php" role="button">Dashboard</a>
<a class="btn read" style="background-color: gold; color:black;" href="logout.php" role="button">Logout</a>
<?php
}
else if(isset($_SESSION['cst_id']))
{
?>
<a class="btn read" style="background-color: gold; color:black;" href="customeraccount.php" role="button">Account</a>
<a class="btn read" style="background-color: gold; color:black;" href="logout.php" role="button">Logout</a>
<?php
}
else
{
?>
<a class="btn read" style="background-color: gold; color:black;" href="customerlogin.php" role="button">Login</a>
<a class="btn read" style="background-color: gold; color:black;" href="customerregister.php" role="button">Register</a>
<?php
}
?>					
					</div>
