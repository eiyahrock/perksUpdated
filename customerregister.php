...
<html>
<head>
<title>PerksFinance - Registration Panel</title>
<link href="//maxcdn.bootstrapcdn.com/bootstrap/4.1.1/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
<script src="//maxcdn.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.min.js"></script>
...
function validateform()
{
	...
	{
		document.getElementById("errcst_email").innerHTML = "Entered Email Address is not valid....";
		errchk = "True";
	}
	if(document.getElementById("cst_email").value == "")
	{
		document.getElementById("errcst_email").innerHTML="Kindly enter Email Address.";
		errchk = "True";
	}
