            ...
            <div class="footer-top text-center">
                <h2>
                    <a class="navbar-brand" href="index.php">
                        <span class="fa fa-money"></span> PerksFinance
                    </a>
                </h2>
            </div>
        </div>
    ...
    <div class="copy-right">
        <div class="container">
            <div class="row">
                <p class="copy-right-grids text-md-left text-center my-sm-4 my-4 col-md-6">© <?php echo date("Y"); ?> PerksFinance Managed by BSIT3C. All Rights Reserved 
                </p>
<?php
...
<div class="w3-pvt-footer text-md-right text-center mt-4 col-md-5">
	<ul class="list-unstyled w3-pvt-icons">
		<li>
			<a href="userlogin.php" class="btn btn-dark">
				Staff Login
			</a>
		</li>
	</ul>
